...
namespace Assets.Code.ReciclableObjects.PopUps
{
    public class PopUpSpawner : MonoBehaviour, EventObserver
    {
        ...
        private void Start()
        {
            ...
            eventQueue.Subscribe(EventIds.BadProjectileDamageAmount, this);
        ...
        private void OnDestroy()
        {
            ...
            eventQueue.Unsubscribe(EventIds.BadProjectileDamageAmount, this);
        }
        ...
        public void Process(EventData eventData)
        {
            ...
            if (eventData.EventId == EventIds.BadProjectileDamageAmount)
            {
                var projectileDestroyedEventData = (BadProjectileDamageAmountEventData)eventData;
                SpawnDamageHpPopUp(projectileDestroyedEventData.HpToRest);
            }
        }
    }
}