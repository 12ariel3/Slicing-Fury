...
namespace Assets.Code.Common.Settings
{
    public class SettingsSystemImpl : SettingsSystem
    {
        ...
        private const string _soundIntensityData = "SoundIntensityData";
        ...
        {
            var userData = _dataStore.GetData<UserData>(_soundIntensityData)
                        ?? new UserData();
            return userData.SoundIntensity;
        }

        public void SaveSoundIntensity(float soundIntensity)
        {
            var userData = new UserData { SoundIntensity = soundIntensity };
            _dataStore.SetData(userData, _soundIntensityData);
        }
