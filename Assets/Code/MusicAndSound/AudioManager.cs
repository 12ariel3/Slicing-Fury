...
namespace Assets.Code.MusicAndSound
{
    public class AudioManager : MonoBehaviour, EventObserver
    {
        ...
        [SerializeField] private SwordAudioScriptableObject[] _swordSounds;
        ...
        private Dictionary<string, SwordAudioScriptableObject> _idToSwordSounds;
        ...
        private void SetVolumeIntensity()
        {
            ...
            _otherSfxSource.volume = settingsSystem.GetSoundIntensity();
        ...
        private void CreateAllDictionaries()
        {
            ...
            _idToSwordSounds = new Dictionary<string, SwordAudioScriptableObject>();
        ...
        public void PlaySword(string name)
        {
            ...
            {
                if (!_idToSwordSounds.TryGetValue(name, out SwordAudioScriptableObject audio))
                {
                    throw new Exception($"Sword Sound {name} not found");
                }

                AudioClip randomAudio = audio.GetRandomAudioClip();


                _swordSource.PlayOneShot(randomAudio);
