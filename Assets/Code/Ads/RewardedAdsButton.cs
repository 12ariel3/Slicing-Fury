...
public class RewardedAdsButton : MonoBehaviour, IUnityAdsLoadListener, IUnityAdsShowListener, EventObserver
{
    ...
    private string _spinWheelReward = "SlicingFurySpinWheel";
    private string _rewardMultiplierX3 = "SlicingFuryVictoryRewardMultiplierX3";
    private string _gameOverExtraLife = "SlicingFuryGameOverExtraLife";
